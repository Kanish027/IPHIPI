      ...
      <div className="max-w-screen-lx mx-auto md:py-20 md:flex md:justify-between md:items-center">
        <div className="md:pt-0 text-center md:text-left">
          ...
          <p className="font-light mb-2 learn_more_text md:max-w-xl">
            ...
            others. It functions as a &quot;smart&quot; layer between your
            device and any online communication platform, eliminating all
            background noise, recording, and capturing transcriptions and
            meeting notes.
          </p>
        </div>
        <div className="supported_apps">
          <Image
            ...
            alt="Supported communication apps illustration"
            width={658}
            height={394}
          />
        </div>
